/*
Adaptado: http://oauth.googlecode.com/svn/code/c/liboauth/src/sha1.c

Testado no windows 7 x64 com dev c++ 5.7.1 com gcc x64
*/
#include <stdio.h>
#include <stdint.h>
#include <string.h>
...
int main (int argc, char **argv) {
	...
	// SHA tests
	printf("Testando: \n String: %s Tamanho: %d \n",valor,strlen(valor));
	printf("Esperado: a9993e364706816aba3e25717850c26c9cd0d89d\n");
	printf("Resultou:");
	sha1_init(&s);
	sha1_write(&s, valor, strlen(valor));
